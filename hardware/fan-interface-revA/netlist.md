...
| --- | --- |
| `VIN12_RAW` | J1.1 -> F1.1 |
| `VIN12_PROT` | F1.2 -> D1.A (pin 2) |
| `FAN12` | D1.K (pin 1) -> J2.2, J3.2, C1.1, C2.1 |
| `GND` | J1.2, J2.1, J3.1, C1.2, C2.2, Q1.S, J4.2, R2.2 |

D1 is a series Schottky diode: anode toward the fused input, cathode toward the fans. With the stated fan current, its voltage drop is acceptable; confirm temperature during startup testing. R3.2 and R5.2 are tach signals, never ground.
